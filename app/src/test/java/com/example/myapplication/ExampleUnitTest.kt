...
import com.example.myapplication.UnitTestUtils.*
import com.example.myapplication.api.APIClient.setConnection
...
internal class MockServerDispatcher {
    ...
    val mockedResponse = arrayOf(
        SinglePostResponse(0, 0, "name00", "email00@example.com", "body00"),
        SinglePostResponse(1, 1, "name01", "email01@example.com", "body01")
    )
